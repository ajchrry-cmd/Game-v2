        ...
        {isBattleWheel && (
          <div className="battle-wheel-editor">
            <div className="editor-header">
              <h2>Wheel Editor</h2>
              <p className="editor-subtitle">Drag to reorder • Click color to change</p>
            </div>
            <div className="segments-list">
              {currentWheel.segments.map((segment, index) => (
                <div
                  key={index}
                  className={`segment-row-compact ${draggedIndex === index ? 'dragging' : ''}`}
                  draggable
                ...
                >
                  ...
                  <span className="segment-number-compact">#{index + 1}</span>
                  <div
                  ...
                  <input
                    ...
                    className="segment-name-compact"
                  />
                  <div className="weight-section-compact">
                    <input
                      ...
                      className="weight-slider-compact"
                    ...
                    />
                    <span className="percentage-compact">{calculatePercentage(currentWheel.segments, segment.weight || 1)}%</span>
                  </div>
                  <button
